...
def sort_medianIter(qubitPositions, graph,rounds): 
     for round in range(0, rounds): 
            choice=round%2
            if round==0: 
                qubitPositions[1]=sort_median(qubitPositions[0], qubitPositions[1], graph)

            else: 
                qubitPositions[0]=sort_median(qubitPositions[1], qubitPositions[0], graph)
