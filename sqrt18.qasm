...
u3(0,0,pi/4) q[1];
cz q[1],q[0];
u3(0,-1.7350096829981627,-1.40658297059163) q[0];
cz q[0],q[6];
u3(pi/2,-pi,-pi) q[1];
cz q[1],q[8];
u3(pi/4,-pi/2,pi/2) q[13];
reset q[13];
u3(0,1.4065829705916304,-1.4065829705916302) q[13];
u3(0,-1.7350096829981627,-1.40658297059163) q[2];
cz q[2],q[10];
u3(0,1.4065829705916304,-1.4065829705916302) q[10];
u3(0,-1.7350096829981627,-1.40658297059163) q[3];
u3(0,-1.7350096829981627,-1.40658297059163) q[4];
u3(0,-1.7350096829981627,-1.40658297059163) q[5];
cz q[5],q[10];
u3(pi/2,0,0) q[10];
cz q[10],q[16];
u3(pi/4,pi/2,-pi/2) q[16];
